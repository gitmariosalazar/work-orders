...
export class WorkOrderAdapter {
  static fromWorkOrderSQLResponseToWorkOrderResponse(
    ...
    return {
      ...
      createdUserId: workOrderSQLResponse.created_user_id || '',
      assignedUserId: workOrderSQLResponse.assigned_user_id || null,
      completedUserId: workOrderSQLResponse.completed_user_id || null,
