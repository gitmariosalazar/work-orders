...
export class WorkOrderObservationController {
  ...
  async createWorkOrderObservation(
    @Payload() workOrderObservation: CreateWorkOrderObservationRequest,
  ) {
    return this.workOrderObservationService.createWorkOrderObservation(
  ...
  async updateWorkOrderObservation(
    ...
    return this.workOrderObservationService.updateWorkOrderObservation(
  ...
  async getWorkOrderObservationsByWorkOrderId(@Payload() workOrderId: string) {
    return this.workOrderObservationService.getWorkOrderObservationsByWorkOrderId(
      workOrderId,
    );
  }
