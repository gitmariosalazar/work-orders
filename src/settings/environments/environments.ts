...
interface EnvironmentsVariables {
  ...
  KAFKA_TOPIC: string;
  WORK_ORDERS_KAFKA_CLIENT_ID: string;
  WORK_ORDERS_KAFKA_GROUP_ID: string;
  WORK_ORDERS_KAFKA_CLIENT: string;
...
const environmentsSchema = Joi.object<EnvironmentsVariables>({
  ...
  WORK_ORDERS_KAFKA_CLIENT_ID: Joi.string().required(),
  WORK_ORDERS_KAFKA_GROUP_ID: Joi.string().required(),
  WORK_ORDERS_KAFKA_CLIENT: Joi.string().required(),
...
export const environments: EnvironmentsVariables = {
  ...
  WORK_ORDERS_KAFKA_CLIENT_ID: envVars.WORK_ORDERS_KAFKA_CLIENT_ID,
  WORK_ORDERS_KAFKA_GROUP_ID: envVars.WORK_ORDERS_KAFKA_GROUP_ID,
  WORK_ORDERS_KAFKA_CLIENT: envVars.WORK_ORDERS_KAFKA_CLIENT,
